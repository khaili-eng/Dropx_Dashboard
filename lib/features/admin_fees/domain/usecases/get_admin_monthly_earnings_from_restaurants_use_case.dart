...
class GetAdminMonthlyEarningsFromRestaurantsUseCase {
  final AdminFeesRepository repository;

  GetAdminMonthlyEarningsFromRestaurantsUseCase(this.repository);
  Future<Either<ServerException, List<RestaurantEarningEntity>>> call(
    int year,
    int month,
  ) async {
    return await repository.getAdminMonthlyEarningsFromRestaurants(year, month);
  }
}
